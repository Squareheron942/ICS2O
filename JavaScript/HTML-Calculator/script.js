...
function negate() {
  ...
  if (document.getElementById('screen').value.charAt(0) == '-') {
    document.getElementById('screen').value = document.getElementById('screen').value.replace('-', '');
...
function cos() {
  document.getElementById('screen').value = +Math.cos(document.getElementById('screen').value * Math.PI / 180).toPrecision(8);
}
